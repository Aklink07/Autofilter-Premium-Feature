...
PICS = (environ.get('PICS', 'https://graph.org/file/cf222b3ace413dfe7ff79-114a5803e920dd2e4a.jpg')).split()  # Sample pic
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003700566416')  # Request channel id (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003807171163'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HUNTINGBACKUPGROUP') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TechnicalAklink') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/latestmovisaupdates') # Update channel link for the bot
